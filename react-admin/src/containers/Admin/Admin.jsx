                    ...
                    <Layout>
                        ...
                        <Content className='content'>
                            <Routes>
                                ...
                                <Route path="/prod_about/product/detail/:id" element={<Detail/>}/>
                                <Route path="/prod_about/product/add_update" element={<AddUpdate/>} exact/>
                                <Route path="/prod_about/product/add_update/:id" element={<AddUpdate/>}/>
